    ...
    <Box id="vision" w="100%" py="100px" bg="white">
      <Container maxW="container.lg">
        ...
        <Box position="relative" mt={16}>
          <Box px={3} w="60%">
            <Heading fontSize={{lg:"38",sm:"19"}} lineHeight="40px" fontWeight="700">
          ...
          <Image src={ChatbotImage} width={{sm:"50%"}} position="absolute" top="0" right="0" transform={{lg:"translate(100px, -125px)",sm:"translate(70px, -50px)"}}/>
        </Box>
        <Box mt={20}>
