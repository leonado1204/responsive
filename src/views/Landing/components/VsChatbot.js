...
function VsChatbot() {
  return (
    <Flex id="features" justifyContent="center" w="100%" bg="linear-gradient(180deg, gray.50, rgba(239, 241, 243, 0) 100%)" pt="150px" pb="60px">
      <Box w="800px" m={{sm:"15px"}} bg="white" boxShadow="-8px 8px 10px rgba(0, 0, 0, 0.4), 0px 0px 30px #51ECE9, -8px 3.20036px 30px #000000, inset 0px 0px 48.0054px rgba(56, 211, 209, 0.3), inset 0px 0px 32.0036px rgba(56, 211, 209, 0.3), inset 0px 0px 20.0023px rgba(56, 211, 209, 0.4)" borderRadius="2xl">
