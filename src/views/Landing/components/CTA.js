    ...
    <Box w="100%" pb="100px" bg="white">
      <Container maxW="container.sm">
        ...
        <Box mt={12} textAlign="center" position="relative">
          ...
          <Image src={InquireBotImage} display={{lg:"flex",sm:"none"}} position="absolute" top="0" left="0" transform="translate(-350px, -80px)" />
          <Image src={ThomasImage} display={{lg:"flex",sm:"none"}} position="absolute" top="0" right="0" transform="translate(350px, -150px)" />
        </Box>
      </Container>
    </Box>
  );
