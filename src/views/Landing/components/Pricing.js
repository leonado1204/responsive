...
function PricingCard({ name, price, content, color, isRecommended }) {
  return (
    <Box justifyContent="center" cow="300px" maxW="100%" boxShadow="-4px 4px 20px rgba(0, 0, 0, 0.3)" borderWidth="3px" borderColor={color} borderRadius="2xl" px={8} py={12} pb={8} position="relative">
      {isRecommended && (
  ...
  return (
    <Box id="pricing" w="100%" bg="white" py="100px">
      <Container maxW="container.lg">
        <Box textAlign="center">
          <Heading fontSize={{lg:"60", sm:"30"}} fontWeight="700" lineHeight="70px">
            Try InquireBot for FREE!
          </Heading>
          <Text fontSize={{lg:"28", sm:"18"}} lineHeight="35px" mt={8}>
