  ...
  return (
    <Box w="100%" bg="#344966">
      ...
      <Container bg="#344966" maxW="container.lg" py="20px">
        <Heading color="#FFF275" fontSize={{lg:"60",sm:"30"}} lineHeight="70px" textAlign="center">
          Welcome to InquireBot!
        </Heading>
        <Heading as="h3" textAlign="center" color="white" fontSize={{lg:"28px",sm:"18px"}} lineHeight="35px" mt={2}>
